...
'''
'''
    This module was downloaded from http://research.variancia.com/czech_stemmer/
    It was provided under Creative Commons Attribution 3.0 Unported License (https://creativecommons.org/licenses/by/3.0/) license.
'''
import re
import sys
